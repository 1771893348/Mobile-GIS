...
public class QueryResultAdapter extends BaseExpandableListAdapter {
    Vector<Recordset> mResultData=new Vector<>();//查询结果
    MapControl mMapControl;
    Context mContext;
    TrackingLayer mTrackingLayer;//动态层
    MapView mMapView;
...
//						mDynView.clear();
                    ...
                    calloutLocation.setOnClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View v) {
                            ...
                            callout.setStyle(CalloutAlignment.BOTTOM);//设置风格
                            callout.setBackground(Color.WHITE, Color.WHITE);//设备北京
                            callout.setLocation(calloutLocation.getLocationX(), calloutLocation.getLocationY());//设置位置
...
//								calloutView.setLayoutParams(params);
                            ...
                            mMapView.addCallout(callout,"POI");//添加po点
                            mMapView.refresh();
